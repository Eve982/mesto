export default class Card {
  ...
  setLikes(data) {
    ...
    this._isLiked
      ? this._buttonLike.classList.add(
          this._cardSelectors.cardLikeActiveSelector
        )
  ...
  _checkOwnCard() {
    if (this.data.owner._id !== this._ownId) {
      this._buttonDelete.classList.add(
        this._cardSelectors.cardHideDeleteButtonSelector
      );
    }
    return;
  }
  ...
  fillCard() {
    ...
    this._cardImage = this._element.querySelector(
      this._cardSelectors.cardImageSelector
    );
    this._buttonLike = this._element.querySelector(
      this._cardSelectors.cardLikeSelector
    );
    this._buttonDelete = this._element.querySelector(
      this._cardSelectors.cardDeleteButtonSelector
    );
    this._likes = this._element.querySelector(
      this._cardSelectors.cardLikeCounterSelector
    );

    this._element.querySelector(
      this._cardSelectors.cardNameSelector
